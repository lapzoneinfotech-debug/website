  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 flex justify-between items-end pointer-events-none">
      ...
      <button 
        ...
        className="pointer-events-auto bg-[#25D366] hover:bg-[#1ebe5b] text-white px-4 py-2.5 rounded flex items-center gap-2 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
      >
